...
export const posts: Post[] = [
  {
    ...
    content: `우리는 인간의 능력을 측정하는 데 놀라울 정도로 조잡한 도구들을 써왔다. 수능은 18년의 학습을 하루의 마크시트로 압축하고, 토익은 비즈니스 영어라는 광활한 영토를 990점짜리 자로 재단한다. 누구도 완벽하다고 생각하지 않지만, 더 나은 대안이 없었기에 사회 전체가 이 불완전한 프록시에 합의해왔다. 대학 입학, 취업, 승진. 인생의 관문마다 이 숫자들이 문지기를 자처한다.
