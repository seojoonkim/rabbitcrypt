...
export const posts: Post[] = [
  {
    ...
    content: `EVA-00의 색은 원래 오렌지였다. 레이와의 싱크로율이 낮아 폭주했고, 재건 이후 라이트 블루로 교체됐다. MelGeek이 에반게리온 30주년 기념 레이 에디션 키보드에 선택한 건 바로 그 두 번째 EVA-00의 배색이다. 알루미늄 합금 케이스에 EVA-00 플러그슈트의 라이트 블루와 화이트가 그대로 입혀졌고, 투명 PC 키캡 아래 사우스페이싱 RGB가 냉백으로 새어 나오면서 레이 특유의 차갑고 정밀한 분위기를 재현한다. 
