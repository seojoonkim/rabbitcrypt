...
export const posts: Post[] = [
  {
    ...
    content: `프로듀스101 투표조작 사건을 기억하는가. 수백만 명이 돈과 시간과 감정을 쏟아부은 투표가, 뒷방에서 숫자 몇 개 고치는 것으로 무너졌다. 사실 우리는 늘 의심하고 있었다. 대통령 선거마다 조작 루머가 돌고, 대형 오디션이 끝날 때마다 집계 방식이 도마 위에 오르는 나라에서, 누가 투표 시스템을 끝까지 믿고 있었을까. 대부분은 믿는 편이다. 다만 완벽하게는 아니다. 시스템을 무너뜨리는 건 거대한 배신이 아니라 그 마지막 1%의 틈이다.
지난달 매경이 주최한 월드크립토포럼(World Crypto Forum)에서 모드하우스 백광현 부대표, 그리고 아르테미스 희진과 패널 토론을 했다. 모드하우스는 4년 전 나와 정병기 대표의 아이디어에서 출발해 해시드가 벤처빌딩한 K-POP 엔터테인먼트 스타트업이다. 팬을 소비자가 아니라 의사결정 구조 안으로 들이는 실험을 하고 있다. 포럼에서 내가 가장 강조한 건 이것이었다. 블록체인을 쓴 가장 큰 이유는 기존 시스템이 가진 99%의 신뢰를 100%에 가깝게 끌어올리기 위해서라는 것.
...
❤9👍3`,
...

  {
    ...
    content: `내가 아는 스무 살 근처의 친구들 몇몇은 버스에서 잔다. 침대에서 자면 시간이 아깝다는 뜻이다. 나머지 시간은 거의 전부 코드를 쓰거나 무언가를 만드는 데 몰입한다. 이런 이들에게 대학의 의미를 묻는 일은, 이미 물속에서 헤엄치고 있는 사람에게 수영장 등록부터 하라고 권하는 것과 비슷하다.
...
❤29👍10`,
...

  {
    ...
    content: `어느 날 아침, 당신이 잠에서 깨기 전에 세 가지 일이 이미 처리되어 있다고 상상해보자. 하나는 미팅 수락, 하나는 제품 구매, 하나는 누군가의 제안에 대한 정중한 거절. 셋 다 당신의 에이전트가 했다. 문장은 당신 말투와 비슷하고, 기준도 대체로 당신답다. 문제는 그다음이다. 그 세 가지 결정 중 어디까지를 당신은 “내가 한 일”이라고 인정할 수 있을까.
