...
export const posts: Post[] = [
  {
    ...
    content: `오늘 하루 바이브 코딩 중간중간 대기 시간을 모아 메모했다. 에이전트 시대가 오면 세상이 어떻게 바뀔지, 평소 스쳐지나가던 생각들을 순서나 중요도 없이 떠오르는 대로 풀어놓은 것이다. 일주일 후에 다시 쓰면 크게 달라질 수도 있는, 가벼운 글이다. 리스트를 완성한 뒤 Claude Opus 4.6, Grok 4.20, Gemini 3.1 Pro, GPT-5.4 네 모델에게 검토를 맡겼는데, 각 항목 끝의 퍼센트는 네 모델이 독립적으로 제시한 "3년 내 실현 확률"의 평균이다. 내 생각과 꽤 다른 숫자들도 있었다.
...
👍21❤10👏5👾1`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'mid',
    summary: '기분 좋게 바이브를 충전했다.
최근 AI 에이전트 생태계에서 일종의 OS 역할을 하고 있는 OpenClaw를 중심으로, 튜닝을 극한까지 밀어붙이...',
