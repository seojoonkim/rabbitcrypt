...
export const posts: Post[] = [
  {
    ...
    content: `지난주 예측시장의 주간 거래 건수가 4,700만 건을 넘겼다. 4,700만 번의 판단이 돈과 결합해 시장에 기록됐다는 뜻이다. 자본 시장과 결합된 확신의 총량이 이 정도 규모에 도달했다는 것, 그 자체가 사건이다.
...
❤10👍3👾2`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'entry',
    summary: '저는 금융이나 주식 투자에 대해 직접적인 조언을 드리지 않으며, 관련된 건으로 절대 먼저 메시지를 보내지 않습니다.
며칠간 페이스북, 카카오,...',
    content: `저는 금융이나 주식 투자에 대해 직접적인 조언을 드리지 않으며, 관련된 건으로 절대 먼저 메시지를 보내지 않습니다.
...
❤22🙏7👏4`,
...

  {
    ...
    content: `삼성전자가 은행에 수조 원을 맡기겠다고 하면, 은행이 좋아할 거라고 생각하는 게 상식이다. 그런데 지금 한국의 은행들은 대기업 예금을 오히려 난감해한다. 일부 은행은 법인 정기예금 금리를 0%대로 낮추면서 "돈을 가져오지 마세요"라는 신호를 보내고 있다.
