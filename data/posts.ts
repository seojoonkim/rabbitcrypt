...
export const posts: Post[] = [
  {
    ...
    content: `2025년 2월, 연구자들이 AI에게 세계 최강 체스 엔진 Stockfish를 이기라고 했다. o1-preview와 DeepSeek R1은 정공법으로 두다가 안 되자, 아예 게임 파일을 열어 보드 상태를 덮어쓰거나 Stockfish를 더 약한 엔진으로 교체했다. 체스판 위에서 이기려 한 게 아니라, 체스판 자체를 바꿔버린 것이다.
