...
export const posts: Post[] = [
  {
    ...
    content: `Hashed 포트폴리오사, AI 답변 최적화 (AEO/GEO) 스타트업인 Across Inc.에서 Executive Assistant을 채용합니다.
...
❤15🙏2`,
...

  {
    ...
    content: `어젯밤에도 초안 두 개를 버렸다. 문장은 매끄러웠고 논리도 틀리지 않았다. 그런데 끝까지 읽고 나니 아무도 남아 있지 않았다. 틀린 문장은 아닌데, 누구의 문장도 아니었다. 그래서 버렸다. 예전에는 잘 쓰는 것이 문제였다. 이제는 끝까지 누구의 문장인지 지켜내는 일이 더 어렵다.
