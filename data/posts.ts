...
export const posts: Post[] = [
  {
    ...
    content: `언제부터인지 모른다. 다만 어느 순간 나는 내가 복사될 수 있는 사람이 됐다는 것을 알았다.
...
❤13👍3👾2`,
...

  {
    ...
    content: `내가 쓰는 도구가 내 사고방식을 만든다. 내가 검색하는 방법이 내가 보게 될 정보를 결정한다. 내가 쓰는 AI가 내가 받을 답을 결정한다. 인프라를 남에게 맡기는 순간, 나는 그 인프라의 제품이 된다.
